 ...
 * @author imran
 *
 *This Class is Used to read the Url from Excel sheet,Launch the browser and Update the excel sheet.
 * 
 */
...
class Check_application_url {
	...
	String current_url;
	String page_title;
	String file_path = "C:\\Users\\sjariwala\\Documents\\My Received Files\\Url_Test_Data.xls";
	...
	public void Launch_Browser(String browser) throws Exception {
		...
		if (browser.equalsIgnoreCase("firefox")) {
			...
			File file = new File(
					"D:\\Neustar\\Automation App support Tasks\\URL testing automation\\chromedriver.exe");
			...
			// Internet Explorer
			File file = new File(
					"C:\\Users\\sjariwala\\Desktop\\aa\\IEDriverServer.exe");
	 ...
	 * After Update excel sheet it forward request to Main Controller to read the data from updated excel.
	 * This is also handle the two request at same time.

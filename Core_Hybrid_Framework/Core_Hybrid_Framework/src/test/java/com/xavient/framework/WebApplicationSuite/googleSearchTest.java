...
public class googleSearchTest {
	...
	public void googleSearchTest(Hashtable<String, String> data)
	...
	public void googleSearchVerifyTextTest(Hashtable<String, String> data)
			throws InterruptedException, IOException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public void googleSearchVerifyTextTestq(Hashtable<String, String> data)
			throws InterruptedException, IOException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public void googleSearchVerifyTextTestqw(Hashtable<String, String> data)
			throws InterruptedException, IOException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
